...
import loginImageDark from "./../img/login-office-dark.jpeg"
import loginImage from "./../img/login-office.jpeg"
        ...
        <div className="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
          <div className="flex flex-col overflow-y-auto md:flex-row">
            <div className="h-32 md:h-auto md:w-1/2">
              <img aria-hidden="true" className="object-cover w-full h-full" src={loginImageDark} alt="Office" />
            ...
            @error('email') border-red-900 @enderror"
                ...
                <p className="mt-1">
                  <a className="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="./create-account.html">
                    Create account
                  </a>
                </p>
              </form>
